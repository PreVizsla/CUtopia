...
function timeDifference(current, previous) {
    ...
    if (elapsed < msPerMinute) {
        ...
        if(Math.round(elapsed/1000)==1.0) {
        ...
        if(Math.round(elapsed/msPerMinute)==1.0) {
        ...
        if(Math.round(elapsed/msPerHour)==1.0) {
        ...
        if(Math.round(elapsed/msPerDay)==1.0) {
        ...
        if(Math.round(elapsed/msPerMonth)==1.0) {
        ...
        if(Math.round(elapsed/msPerYear)==1.0) {
