...
router.get("/:id", async (req, res, next) => {
    ...
    if(postData.replyTo !== undefined) {
        ...
        if(results.replyTo.content != null) { // ADDING LINKS TO REPLIES
            const postBody = results.replyTo.content
            ...
            results.replyTo.content = textToArr.join(" ")
        }
    }
...
async function getPosts(filter) {
    ...
    results.forEach(post => { // ADDING LINKS TO RETWEETS
        ...
        if(post.retweetData != null) {
            ...
            if(post.retweetData.content != null) {
                const postBody = post.retweetData.content
                ...
                post.retweetData.content = textToArr.join(" ")
            }
        }    
    })
